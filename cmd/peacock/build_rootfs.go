...
// Phase 4 of the build pipeline. Called from `runBuild` in build.go after
// phase 3 (build_initramfs.go) completes and before phase 5
// (build_image.go) packs the disk image. Builds (or extracts) the kernel,
